...
class PipelineStepCreateRequestSchema(BaseSchema):
    ...
    template = fields.Nested(
        'tahiti.schema.PipelineCreateRequestSchema',
        required=True)
...
class PipelineTemplateStepCreateRequestSchema(BaseSchema):
    ...
    enabled = fields.Boolean(required=True)
    template = fields.Nested(
        'tahiti.schema.PipelineTemplateCreateRequestSchema',
        required=True)
...
class PipelineTemplateStepItemResponseSchema(BaseSchema):
    ...
    enabled = fields.Boolean(required=True)
    template = fields.Nested(
        'tahiti.schema.PipelineTemplateItemResponseSchema',
        required=True)
...
class PipelineTemplateStepListResponseSchema(BaseSchema):
    ...
    enabled = fields.Boolean(required=True)
    template = fields.Nested(
        'tahiti.schema.PipelineTemplateListResponseSchema',
        required=True)
