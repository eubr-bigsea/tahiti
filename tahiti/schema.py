    ...
    for field, errors in list(validation_errors.items()):
        if isinstance(errors, dict):
            ...
            for error in errors:
                ...
                if found:
                    final_errors.append(f"{gettext(found[0][0])} {found[0][1]}")
                else:
...
class PlatformListResponseSchema(BaseSchema):
    ...
    version = fields.String(
        required=False, allow_none=True, load_default=1.0, dump_default=1.0
    )
...
class OperationSubsetListResponseSchema(BaseSchema):
    ...
    platform = fields.Nested(
        "tahiti.schema.PlatformListResponseSchema", required=True
    )
    operations = fields.Nested(
        "tahiti.schema.OperationListResponseSchema", allow_none=True, many=True
    )
...
class OperationSubsetCreateRequestSchema(BaseSchema):
    ...
    name = fields.String(required=True)
    platform = fields.Nested(
        "tahiti.schema.PlatformCreateRequestSchema", required=True, only=["id"]
    )
    operations = fields.Nested(
...
class OperationSubsetItemResponseSchema(BaseSchema):
    ...
    name = fields.String(required=True)
    platform = fields.Nested(
        "tahiti.schema.PlatformItemResponseSchema", required=True
    )
    operations = fields.Nested(
        "tahiti.schema.OperationItemResponseSchema", allow_none=True, many=True
    )
...
class RoleOperationSubsetCreateRequestSchema(BaseSchema):
    ...
    subset = fields.Nested(
        "tahiti.schema.OperationSubsetCreateRequestSchema", required=True
    )
...
class RoleOperationSubsetItemResponseSchema(BaseSchema):
    ...
    role_id = fields.Integer(required=True)
    subset = fields.Nested(
        "tahiti.schema.OperationSubsetItemResponseSchema", required=True
    )
...
class OperationListResponseSchema(BaseSchema):
    ...
    enabled = fields.Boolean(required=True)
    description = fields.String(required=True)
    type = fields.String(required=True, validate=[OneOf(OperationType.values())])
    icon = fields.String(required=True)
    ...
    platforms = fields.Nested(
        "tahiti.schema.PlatformListResponseSchema", required=True, many=True
    )
    forms = fields.Nested(
        "tahiti.schema.OperationFormListResponseSchema", required=True, many=True
    )
    ports = fields.Nested(
        "tahiti.schema.OperationPortListResponseSchema", required=True, many=True
    )
...
class OperationCreateRequestSchema(BaseSchema):
    ...
    platforms = fields.Nested(
        "tahiti.schema.PlatformCreateRequestSchema", required=True, many=True
    )
    forms = fields.Nested(
...
class OperationItemResponseSchema(BaseSchema):
    ...
    platforms = fields.Nested(
        "tahiti.schema.PlatformItemResponseSchema", required=True, many=True
    )
    forms = fields.Nested(
        "tahiti.schema.OperationFormItemResponseSchema", required=True, many=True
    )
    ports = fields.Nested(
        "tahiti.schema.OperationPortItemResponseSchema", required=True, many=True
    )
    scripts = fields.Nested(
...
class OperationUpdateRequestSchema(BaseSchema):
    ...
    type = fields.String(
        required=False, allow_none=True, validate=[OneOf(OperationType.values())]
    )
    ...
    platforms = fields.Nested(
        "tahiti.schema.PlatformUpdateRequestSchema", allow_none=True, many=True
    )
    forms = fields.Nested(
...
class OperationPortListResponseSchema(BaseSchema):
    ...
    slug = fields.String(required=True)
    type = fields.String(
        required=True, validate=[OneOf(OperationPortType.values())]
    )
    description = fields.String(required=True)
...
class OperationCategoryCreateRequestSchema(BaseSchema):
    ...
    order = fields.Integer(
        required=False, allow_none=True, load_default=1, dump_default=1
    )
...
class OperationFormListResponseSchema(BaseSchema):
    ...
    enabled = fields.Boolean(
        required=False, allow_none=True, load_default=True, dump_default=True
    )
...
class ApplicationCreateRequestSchema(BaseSchema):
    ...
    type = fields.String(
        required=True, validate=[OneOf(ApplicationType.values())]
    )
...
class OperationScriptListResponseSchema(BaseSchema):
    ...
    name = fields.String(required=True)
    type = fields.String(required=True, validate=[OneOf(ScriptType.values())])
    enabled = fields.Boolean(required=True)
    description = fields.String(required=True)
...
class PlatformPluginItemResponseSchema(BaseSchema):
    ...
    status = fields.String(
        required=False, allow_none=True, validate=[OneOf(PluginStatus.values())]
    )
...
class OperationFormFieldListResponseSchema(BaseSchema):
    ...
    type = fields.String(required=True, validate=[OneOf(DataType.values())])
...
class PipelineCreateRequestSchema(BaseSchema):
    ...
    name = fields.String(required=True)
    description = fields.String(required=False, allow_none=True)
    identifier = fields.String(required=False, allow_none=True)
    enabled = fields.Boolean(required=True)
...
class WorkflowExecuteRequestSchema(BaseSchema):
    ...
    type = fields.String(
        required=False,
        allow_none=True,
        load_default=WorkflowType.WORKFLOW,
        dump_default=WorkflowType.WORKFLOW,
        validate=[OneOf(WorkflowType.values())],
    )
    preferred_cluster_id = fields.Integer(required=False, allow_none=True)
    tasks = fields.Nested(
        "tahiti.schema.TaskExecuteRequestSchema", allow_none=True, many=True
    )
    flows = fields.Nested(
        "tahiti.schema.FlowExecuteRequestSchema", allow_none=True, many=True
    )
    ...
    platform = fields.Nested(
        "tahiti.schema.PlatformExecuteRequestSchema", required=True
    )
    subset = fields.Nested(
        "tahiti.schema.OperationSubsetExecuteRequestSchema", allow_none=True
    )
    pipeline = fields.Nested(
        "tahiti.schema.PipelineExecuteRequestSchema", allow_none=True
    )
...
class WorkflowListResponseSchema(BaseSchema):
    ...
    preferred_cluster_id = fields.Integer(required=False, allow_none=True)
    tasks = fields.Nested(
        "tahiti.schema.TaskListResponseSchema", allow_none=True, many=True
    )
    flows = fields.Nested(
        "tahiti.schema.FlowListResponseSchema", allow_none=True, many=True
    )
    variables = fields.Nested(
    ...
    subset = fields.Nested(
        "tahiti.schema.OperationSubsetListResponseSchema", allow_none=True
    )
    pipeline = fields.Nested(
        "tahiti.schema.PipelineListResponseSchema", allow_none=True
    )
    user = fields.Function(
        lambda x: {"id": x.user_id, "name": x.user_name, "login": x.user_login}
    )
    specification = fields.Function(
        lambda row, ctx: ctx.get("specification", "2.0.0")
    )
...
class WorkflowCreateRequestSchema(BaseSchema):
    ...
    preferred_cluster_id = fields.Integer(required=False, allow_none=True)
    tasks = fields.Nested(
        "tahiti.schema.TaskCreateRequestSchema", allow_none=True, many=True
    )
    flows = fields.Nested(
        "tahiti.schema.FlowCreateRequestSchema", allow_none=True, many=True
    )
    variables = fields.Nested(
    ...
    user = fields.Nested(
        "tahiti.schema.UserCreateRequestSchema", allow_none=True
    )
...
class WorkflowItemResponseSchema(BaseSchema):
    ...
    preferred_cluster_id = fields.Integer(required=False, allow_none=True)
    tasks = fields.Nested(
        "tahiti.schema.TaskItemResponseSchema", allow_none=True, many=True
    )
    flows = fields.Nested(
        "tahiti.schema.FlowItemResponseSchema", allow_none=True, many=True
    )
    variables = fields.Nested(
    ...
    pipeline = fields.Nested(
        "tahiti.schema.PipelineItemResponseSchema", allow_none=True
    )
    user = fields.Function(
        lambda x: {"id": x.user_id, "name": x.user_name, "login": x.user_login}
    )
...
class WorkflowPermissionListResponseSchema(BaseSchema):
    ...
    permission = fields.String(
        required=True, validate=[OneOf(PermissionType.values())]
    )
    user_id = fields.Integer(required=True)
    user_login = fields.String(required=True)
    user_name = fields.String(required=True)
...
class FlowListResponseSchema(BaseSchema):
    ...
    environment = fields.String(
        required=False,
        allow_none=True,
        load_default=DiagramEnvironment.DESIGN,
        dump_default=DiagramEnvironment.DESIGN,
...
class TaskListResponseSchema(BaseSchema):
    ...
    operation = fields.Nested(
        "tahiti.schema.OperationSimpleListResponseSchema", allow_none=True
    )
...
class TaskExecuteRequestSchema(BaseSchema):
    ...
    operation = fields.Nested(
        "tahiti.schema.OperationExecuteRequestSchema", required=True
    )
...
class PipelineStepCreateRequestSchema(BaseSchema):
    ...
    description = fields.String(required=False, allow_none=True)
    enabled = fields.Boolean(required=True)
    workflow_type = fields.String(
        required=False, allow_none=True, validate=[OneOf(WorkflowType.values())]
    )
