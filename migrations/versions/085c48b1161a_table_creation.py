...
def downgrade():
    ...
    if is_psql():
        bind = op.get_bind()
        bind.execute('DROP TYPE IF EXISTS  "ApplicationTypeEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "OperationTypeEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "TaskGroupTypeEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "DataTypeEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "OperationFieldScopeEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "OperationPortTypeEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "OperationPortMultiplicityEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "ScriptTypeEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "PluginStatusEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "PublishingStatusEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "WorkflowTypeEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "DiagramEnvironmentEnumType"')
        bind.execute('DROP TYPE IF EXISTS  "PermissionTypeEnumType"')
    # ### end Alembic commands ###
