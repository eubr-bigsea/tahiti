...
all_commands = [
	...
	(_insert_operation,
        'DELETE FROM operation_form_field_translation WHERE id >= 3078 AND  id <= 3080;'
        'DELETE FROM operation_form_field_translation WHERE id >= 3027 AND  id <= 3029;'),
	(_insert_new_operation_platform,
        'DELETE FROM operation_form_field WHERE form_id = 3022;'
        'DELETE FROM operation_form_field WHERE form_id = 3012;' ),
	(_insert_operation_category_operation,
        'DELETE FROM operation_port_interface_operation_port '
        'WHERE operation_port_id >= 3044 AND operation_port_id <= 3045;'
        'DELETE FROM operation_port_interface_operation_port '
        'WHERE operation_port_id >= 3019 AND operation_port_id <= 3020;'),
	(_insert_operation_form,
        'DELETE FROM operation_port_translation WHERE id >= 3044 AND id <= 3045;'
        'DELETE FROM operation_port_translation WHERE id >= 3019 AND id <= 3020;' ),
	(_insert_operation_form_translation,
        'DELETE FROM operation_port WHERE id >= 3044 AND id <= 3045;'
        'DELETE FROM operation_port WHERE id >= 3019 AND id <= 3020;' ),
	(_insert_operation_operation_form,
        'DELETE FROM operation_translation WHERE id = 3022;'
        'DELETE FROM operation_translation WHERE id = 3012;'),
	(_insert_operation_translation,
    	'DELETE FROM operation_operation_form WHERE operation_id = 3022;'
        'DELETE FROM operation_operation_form WHERE operation_id = 3012;'),
	(_insert_operation_port,
        'DELETE FROM operation_form_translation WHERE id = 3022;'
        'DELETE FROM operation_form_translation WHERE id = 3012;' ),
	(_insert_operation_port_translation,
        'DELETE FROM operation_form WHERE id = 3022;'
        'DELETE FROM operation_form WHERE id = 3012;'),
	(_insert_operation_port_interface_operation_port,
        'DELETE FROM operation_category_operation WHERE operation_id = 3022;'
        'DELETE FROM operation_category_operation WHERE operation_id = 3012;'),
	(_insert_operation_form_field,
        'DELETE FROM operation_platform WHERE operation_id = 3022;'
        'DELETE FROM operation_platform WHERE operation_id = 3012;'),
	(_insert_operation_form_field_translation,
        'DELETE FROM operation WHERE id = 3022;'
        'DELETE FROM operation WHERE id = 3012;'),
