...
def _insert_operation_form_field():
    ...
    data = [
        ...
        ,'EXECUTION', 3001),
        #add-columns
        (3085, 'aliases','TEXT',0,4, '_l,_r','text',None,None,'EXECUTION', 3024),
        #aggregation
        (3086,'attributes','TEXT',1,1,None,'attribute-selector',None,None,'EXECUTION',3025),
        ...
        #load-model
        (3088,'name','TEXT',1,1,None,'text',None,None,'EXECUTION',3026),
        #save-model
        (3089,'name','TEXT',1,2,None,'text',None,None,'EXECUTION',3027),
        (3090,'write_mode','TEXT',1,3,'ERROR','dropdown',None,
        '[{\"value\": \"Overwrite\", \"key\": \"OVERWRITE\"}, '
        '{\"value\": \"Raise error\", \"key\": \"ERROR\"}]','EXECUTION',3027),

        #association-rules
        (3091,'confidence','DECIMAL',1,1,0.9,'decimal',None,None,'EXECUTION',3028),
        (3092,'rules_count','INTEGER',1,2,200,'integer',None,None,'EXECUTION',3028),
        (3093,'col_items','TEXT',1,1,None,'attribute-selector',None,None,'EXECUTION',3028),
        (3094,'col_support','TEXT',1,1,None,'attribute-selector',None,None,'EXECUTION',3028),

        #clean-missing
        (3095,'attributes','TEXT',1,0,None,'attribute-selector',None,None,'EXECUTION',3029),
        (3096,'cleaning_mode','TEXT',1,1,None,'dropdown',None,
            ...
            "{\"key\": \"REMOVE_COLUMN\", \"value\": \"Remove entire column\"}]",'EXECUTION',3029),
        (3097,'value','TEXT',0,2,None,'text',None,None,'EXECUTION',3029),

        #join
        (3098,'left_attributes','TEXT',1,0,None,'attribute-selector',None,None,'EXECUTION',3030),
        (3099,'right_attributes','TEXT',1,0,None,'attribute-selector',None,None,'EXECUTION',3030),
        (3100,'join_type','TEXT',1,0,None,'dropdown',None,
            "[{\"key\": \"inner\", \"value\": \"Inner join\"},"
            "{\"key\": \"left_outer\", \"value\": \"Left outer join\"}, "
            "{\"key\": \"right_outer\", \"value\": \"Right outer join\"}]",'EXECUTION',3030),
        (3101,'keep_right_keys','INTEGER',0,0,None,'checkbox',None,None,'EXECUTION',3030),
        (3102,'match_case','INTEGER',1,0,1,'checkbox',None,None,'EXECUTION',3030),
        (3103,'aliases','TEXT',0,4,'_l, _r','text',None,None,'EXECUTION',3030),

        (3104,'shapefile','TEXT',1,1,None,'text',None,None,'EXECUTION',3031),
        (3105,'polygon','TEXT',0,2,'points','text',None,None,'EXECUTION',3031),
        (3106, 'lat_lon', 'INTEGER', 0, 3, True, 'checkbox', None, None, 'EXECUTION', 3031),

        #stbscan -- appending
        (3107, 'alias','TEXT',0,6, 'Cluster','text',None,None,'EXECUTION', 3021),
...
def _insert_operation_form_field_translation():
    ...
    data = [
        ...
        (3085,'pt','Sufixos para os atributos (2 valores, separados por vírgula)',
...
all_commands = [
    ...
    ('DELETE FROM operation_platform WHERE operation_id = 24 and platform_id = 3;'
     'DELETE FROM operation_platform WHERE operation_id = 15 and platform_id = 3;'
     'DELETE FROM operation_platform WHERE operation_id = 85 and platform_id = 3;'
     'DELETE FROM operation_platform WHERE operation_id = 16 and platform_id = 3;'
     'DELETE FROM operation_platform WHERE operation_id = 21 and platform_id = 3;'
     'DELETE FROM operation_platform WHERE operation_id = 53 and platform_id = 3;',
