...
def _insert_operation_form_field():
    ...
    data = [
        ...
        (4322, 'init_params', 'TEXT', 0, 9, 'kmeans', 'dropdown', None,
         ...
         'EXECUTION', 4031, None),
        (4323, 'weights_init', 'TEXT', 0, 10, 'prediction', 'text', None, None, 'EXECUTION', 4031, None),
...
def _insert_operation_form_field_translation():
    ...
    data = [
        ...
        (4315, 'pt', 'Atributo com a predição (novo)', ''),
...
def _insert_operation_port():
    ...
    data = [
        #Reshape
        (4090, 'INPUT', '', 1, 'ONE', 4042, 'input data'),
        (4091, 'OUTPUT', '', 1, 'ONE', 4042, 'output data'),
        (4092, 'OUTPUT', '', 2, 'MANY', 4042, 'output model'),
    ]
    rows = [dict(list(zip(columns, row))) for row in data]
