...
Revision ID: 87543e2c8d26
Revises: a237518ec5e1
Create Date: 2023-07-16 19:37:02.376738
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('description', sa.String(length=200), nullable=False),
    sa.Column('requirements', mysql.LONGTEXT(), nullable=True),
    sa.Column('help', sa.UnicodeText(), nullable=True),
    sa.Column('code', mysql.LONGTEXT(), nullable=False),
    sa.Column('status', sa.Enum('ENABLED', 'DISABLED', 'SUSPICIOUS', name='CodeStatusEnumType'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
